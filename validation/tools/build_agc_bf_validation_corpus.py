...
def build(output: Path, seed: int) -> dict:
    ...
    # AGC dynamics use stable multi-tone levels. This removes speech-envelope
    # ambiguity from attack/release measurements while retaining exact PCM and
    # the same standalone AGC implementation as the product module.
    ...
    # BF stress: +/- edge TDOA, direction reversal, gain mismatch and diffuse
    # uncorrelated noise. Clean reference is never fed to the processor and is
    # only used by the canonical SI-SDR evaluator.
