...
static void process_lane(vad_state_t *state,
    ...
    result->blend_applied = (uint8_t)blend_applied;
...
int main(int argc, char **argv) {
    ...
    for (;;) {
        ...
        printf(
            ...
            (unsigned)shipping.blend_applied,
