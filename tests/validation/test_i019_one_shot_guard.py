#!/usr/bin/env python3
"""Exercise the active I019 one-shot guard without running fresh research."""
...
class GuardTests(unittest.TestCase):
    ...
    def test_pre_fresh_failure_allows_new_dispatch(self):
        self.execute(**self.history([
            ...
            step(GENERATE,"skipped"),step(DIAGNOSE,"skipped")]))
    ...
    def test_guard_precedes_fresh_steps(self):
        ...
        guard=text.index("      - name: Enforce one-shot I019 diagnostic execution\n")
