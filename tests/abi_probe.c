...
#include <stdio.h>
int main(void) {
    printf("ap_build_info_t=%zu\n", sizeof(ap_build_info_t));
    printf("ap_build_info_t.source_revision=%zu\n", offsetof(ap_build_info_t, source_revision));
    ...
    printf("ap_runtime_options_t=%zu\n", sizeof(ap_runtime_options_t));
    printf("ap_runtime_metrics_t=%zu\n", sizeof(ap_runtime_metrics_t));
    printf("ap_runtime_metrics_t.failed_frames=%zu\n", offsetof(ap_runtime_metrics_t, failed_frames));
    printf("AP_OK=%d\n", (int)AP_OK);
    printf("AP_EINVAL=%d\n", (int)AP_EINVAL);
    printf("AP_EFULL=%d\n", (int)AP_EFULL);
    printf("AP_EEMPTY=%d\n", (int)AP_EEMPTY);
