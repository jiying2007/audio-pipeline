...
- Keep the aggregate objective, scores, decision authority and product DSP unchanged: the selected development candidate, its identifier and its score are bit-identical before and after this change. The gates reject two candidates the aggregate objective had scored as acceptable or merely weak (`ns_floor=0.14` at +0.0358 with all 12 noise cases attenuated worse by up to 0.8119 dB; `aec_mu=0.20` with a VAD false positive rate excursion of +0.0615).
